...
class SearchEventItemWidget extends StatelessWidget {
  const SearchEventItemWidget({super.key, required this.state});
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      _RecommendEventItemImage(image: state.eventImage),
      const SizedBox(height: 8),
      _RecommendEventItemTitle(title: state.eventName),
